...
CREATE TABLE `t_user` (
                        ...
                        `identity` varchar(50) NOT NULL COMMENT '身份证',
                        `name` varchar(100) NOT NULL COMMENT '名字',
                        `birth` int(8) NOT NULL COMMENT '生日',
                        `sex` int(4) NOT NULL COMMENT '性别',
                        `nation` varchar(50) NOT NULL COMMENT '民族',
                        `image` varchar(500) NOT NULL COMMENT '头像 url',
                        `old_type` int(0) NOT NULL COMMENT '老人类别',
                        `marital status` int(4) NOT NULL COMMENT '婚姻状况',
                        `live_status` int(4) NOT NULL COMMENT '居住状况',
                        `address` varchar(500) NOT NULL COMMENT '家庭地址',
                        `province` varchar(50) NOT NULL COMMENT '省份',
                        `city` varchar(50) NOT NULL COMMENT '城市',
                        `country` varchar(50) NOT NULL COMMENT '乡县',
                        `community` varchar(50) NOT NULL COMMENT '社区',
                        `organization` varchar(50) NOT NULL COMMENT '机构组织',
...
CREATE TABLE `t_body_sign` (
                             ...
                             `description` varchar(100) NOT NULL COMMENT '健康描述信息',
                             `create_time` datetime(0) NOT NULL COMMENT '创建时间',
                             `modify_time` datetime(0) NOT NULL COMMENT '修改时间',
                             PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `t_doctor` (
                          ...
                          `sex` int(4) NOT NULL COMMENT '性别',
                          `birth` int(8) NOT NULL COMMENT '生日',
                          `hospital` varchar(100) NOT NULL COMMENT '医院机构',
                          `department` varchar(100) NOT NULL COMMENT '一级科室',
                          `second_department` varchar(100) NOT NULL COMMENT '二级科室',
                          `job_title` varchar(100) NOT NULL COMMENT '职称',
                          `introduction` varchar(100) NOT NULL COMMENT '简介',
                          `skill` varchar(100) NOT NULL COMMENT '擅长技能',
                          `create_time` datetime(0) NOT NULL COMMENT '创建时间',
                          `modify_time` datetime(0) NOT NULL COMMENT '修改时间',
                          PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `t_consult` (
                           ...
                           `doctor_id` varchar(100) NOT NULL COMMENT '回复的医生 ID',
                           `symptoms` varchar(100) NOT NULL COMMENT '症状',
                           `description` varchar(500) NOT NULL COMMENT '病情主诉描述',
                           `record_urls` varchar(1000) NOT NULL COMMENT '病历地址',
                           `doctor_reply` varchar(500) NOT NULL COMMENT '医生回复',
                           `state` int(4) NOT NULL COMMENT '状态，0表示未回复，1表示已回复',
                           `reply_time` datetime(0) NOT NULL COMMENT '医生回复时间',
                           `create_time` datetime(0) NOT NULL COMMENT '创建时间',
                           `modify_time` datetime(0) NOT NULL COMMENT '修改时间',
                           PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `t_reservation` (
                               ...
                               `instructions` varchar(1000) NOT NULL COMMENT '就诊说明',
                               `state` int(4) NOT NULL COMMENT '预约状态，1表示预约中，2表示预约成功，3表示预约失败',
                               `reserve_time` datetime(0) NOT NULL COMMENT '预约时间',
                               `create_time` datetime(0) NOT NULL COMMENT '创建时间',
                               `modify_time` datetime(0) NOT NULL COMMENT '修改时间',
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `t_device` (
                          ...
                          `state` int(4) NOT NULL COMMENT '设备状态，1表示启用，2表示停用，3表示回收',
                          `create_time` datetime(0) NOT NULL COMMENT '创建时间',
                          `modify_time` datetime(0) NOT NULL COMMENT '修改时间',
                          PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `t_remind` (
                          ...
                          `method` int(4) NOT NULL COMMENT '提醒方式',
                          `frequency` int(4) NOT NULL COMMENT '提醒频率',
                          `content` varchar(0) NOT NULL COMMENT '提醒内容',
...
CREATE TABLE `t_association` (
                               ...
                               `name` varchar(100) NOT NULL COMMENT '被关联的老人姓名',
                               `account` varchar(100) NOT NULL COMMENT '被关联的老人账号',
                               `identity` varchar(50) NOT NULL COMMENT '被关联的老人身份证',
                               `state` int(4) NOT NULL COMMENT '关联状态',
                               `create_time` datetime(0) NOT NULL COMMENT '创建时间',
                               `modify_time` datetime(0) NOT NULL COMMENT '修改时间',
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;